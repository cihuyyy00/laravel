...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dasborb/dasbor.blade.css') }}">
    <link rel="stylesheet" href="{{ asset('dasborb/css/charts.blade.css') }}">
    <link rel="stylesheet" href="{{ asset('dasborb/css/widgets.blade.css') }}">
</head>
<body>
...
<script src="{{ asset('dasborb/js/chart.js') }}"></script>
<script src="{{ asset('dasborb/js/chart-responsive.js') }}"></script>
</body>
</html>
